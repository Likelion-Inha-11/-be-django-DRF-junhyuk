...
# 230625 추가 카테고리별 게시글 작성 
class Category(models.Model):
    category_name = models.TextField(verbose_name='카테고리', null = True, max_length= 200)
...
class Post(models.Model):
    ...
    foreign_category = models.ForeignKey(Category, null = True, on_delete=models.CASCADE)
